  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      ...
      <tr class="success">
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{  $register_details->cash_in_hand }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{  $register_details->total_cash - $register_details->total_cash_refund }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
          @lang('lang_v1.total_paymentt')
        </th>
        <td>
      ...
      <tr class="success">
        <th>
          @lang('lang_v1.sale_payments_total')
        </th>
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cheque + $register_details->total_card +$register_details->total_bank_transfer - ($register_details->total_refund - $register_details->total_cash_refund) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
          @lang('lang_v1.sale_payments_total_amount')
        </th>
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash + $register_details->total_cheque + $register_details->total_card +$register_details->total_bank_transfer - $register_details->total_refund  }}</span></b>
        </td>
      </tr>
