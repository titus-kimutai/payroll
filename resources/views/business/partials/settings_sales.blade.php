    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[enable_mspp]', 1,  
                        !empty($pos_settings['enable_mspp']) ? true : false , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.sale_price_is_minimum_sale_price_percentage' ) }} 
                  </label>
                  @show_tooltip(__('lang_v1.minimum_sale_price_help'))
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('default_minimum_spp', __('business.default_sales_minimum_spp') . ':*') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-percent"></i>
                    </span>
                    {!! Form::text('default_sales_spp', @num_format($business->default_sales_spp), ['class' => 'form-control input_number']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-4">
