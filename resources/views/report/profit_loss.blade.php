        ...
        profit_by_products_table = $('#profit_by_products_table').DataTable({
                ...
                footerCallback: function ( row, data, start, end, display ) {
                    ...
                    for (var r in data){
                        ...
                        total_purchase += $(data[r].cost).data('orig-value') ? 
                        parseFloat($(data[r].cost).data('orig-value')) : 0;
                        total_sell += $(data[r].price).data('orig-value') ? 
                        parseFloat($(data[r].price).data('orig-value')) : 0;
                    }
                    // $('#profit_by_products_table .footer_totalcost').html(__currency_trans_from_en(total_purchase));
                    // $('#profit_by_products_table .footer_totalprice').html(__currency_trans_from_en(total_sell));
