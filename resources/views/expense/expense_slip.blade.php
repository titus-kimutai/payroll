...
<html lang="en">
    <head>
        ...
        <title>Receipt-{{$receipt_details->expense_no}}</title>
    </head>
    <body>
        <div class="ticket">
			...
			$all_subtotal=0;
			$subttl=0;
			$all_subtotal= $receipt_details->subtotal_exc_tax + $receipt_details->total_line_discount ; 
			$subttl= $receipt_details->subtotal_exc_tax; 
            ...
            <div class="flex-box">
                ...
                <p class="width-50 text-right">
                	<strong>{{ $receipt_details->subtotal_exc_discount }}</strong>
                </p>
                @else
                <p class="width-50 text-right">
		...
		<!--	@if(!empty($receipt_details->tax_summary_label) )
			@if(!empty($receipt_details->taxes))
