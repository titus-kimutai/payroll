...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $discc = ($discount != 0) ? $this->num_f($discount, $show_currency, $business_details) : 0;
        $ttl=$subtotal_exc_tax+ $total_line_discount+$discount;
        $output['subtotal_exc_discount'] = $this->num_f($ttl, true, $business_details, true);
        ...
        if (!empty($output['taxes'])) {
            ...
            $output['ttltax'] = $this->num_f($total_tax, $show_currency, $business_details);
        }
...
/**
     ...
     * @return array
     */
    public function getexpenseReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        $il = $invoice_layout;
    ...
    */
    public function getListSells($business_id, $sale_type = 'sell')
    {
        $sells = Transaction::leftJoin('contacts', 'transactions.contact_id', '=', 'contacts.id')
                ...
                ->leftJoin('users as u', 'transactions.created_by', '=', 'u.id')
                 ->leftJoin('products as pp', 'tsl.product_id', '=', 'pp.id')
                ...
                ->select(
                    ...
                    DB::raw("GROUP_CONCAT(pp.name SEPARATOR ' ------ ') as total_items"),
